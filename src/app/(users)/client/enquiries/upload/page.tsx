          ...
          <div className="max-w-5xl mx-auto">
            ...
            <div className="mb-8">
              ...
              <p className="text-[#667085] text-sm mt-3">
                Fill in the required data and submit your enquiry. Our team will
                      ...
                      <div
                        ...
                        className={`relative border-2 border-dashed rounded-xl p-6 text-center cursor-pointer transition-all ${
                          dragActive
                            ...
                            : "border-[#D0D5DD] hover:border-primary/50 hover:bg-[#F9FAFB]"
                        }`}
                      >
                        <input
                          ref={fileRef}
                        ...
                        {uploadedFile ? (
                          ...
                          <>
                            <UploadCloud
                              className="mx-auto text-[#98A2B3] mb-2"
                              size={36}
                            />
            ...
            <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/40 backdrop-blur-sm">
              <div className="bg-white rounded-3xl shadow-2xl p-10 max-w-md w-full mx-4 text-center animate-in zoom-in duration-200">
                ...
                <p className="text-[#667085] text-sm leading-relaxed mb-8">
                  Our team will review it, and we will keep you updated with any
                  developments.
                </p>
