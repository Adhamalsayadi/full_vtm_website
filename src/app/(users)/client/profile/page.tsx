...
export default function ClientProfilePage() {
  ...
  return (
    <div className="flex min-h-screen bg-[#F9FAFB]">
      <Sidebar role={isSupplier ? "Supplier" : "Client"} />
      <div className="flex-1 flex flex-col">
        <Header role={isSupplier ? "Supplier" : "Client"} />

        <main className="flex-1 p-6 md:p-10 overflow-auto">
          <div className="max-w-3xl mx-auto">
            <div className="text-[#667085] text-sm font-medium mb-8">
              <Link href={isSupplier ? "/supplier" : "/client"} className="hover:text-black transition-colors">
                Dashboard
              </Link>{" "}
